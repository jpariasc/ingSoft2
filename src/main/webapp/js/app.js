...
var app = angular.module('tiendaApp',
    ['tiendaControllers', 'ngRoute', 'ui.bootstrap']).
    config(['$routeProvider',
        function ($routeProvider) {
            $routeProvider.
                when('/product', {
                    templateUrl: '/partials/show_producto.html',
                    controller: 'ShowProductCtrl'
                }).
                when('/product/create', {
                    templateUrl: '/partials/create_producto.html',
                    controller: 'CreateProductCtrl'
                }).
                when('/product/detail/:websafeProductKey', {
                    templateUrl: '/partials/producto_detail.html',
...
app.factory('oauth2Provider', function ($modal) {
    var oauth2Provider = {
        CLIENT_ID: '479774322380-6j60ahd7lvbmb2ss903ol02vhkofpqhv.apps.googleusercontent.com',
