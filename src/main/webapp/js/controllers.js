...
tiendaApp.controllers.controller('MyProfileCtrl',
    function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
        ...
        $scope.saveProfile = function () {
            ...
            $scope.loading = true;
            gapi.client.tienda.saveProfile($scope.profile).
                execute(function (resp) {
                    $scope.$apply(function () {
                        $scope.loading = false;
                        if (resp.error) {
 ...
 *
 * @description
 * A controller used for the Create products page.
 */
 ...
 *
 * @description
 * A controller used for the Show products page.
 */
 ...
 *
 * @description
 * A controller used for the product detail page.
 */
tiendaApp.controllers.controller('ProductDetailCtrl', function ($scope, $log, $routeParams, HTTP_ERRORS) {
    ...
    /**
     * Invokes the tienda.unregisterForProduct method.
     */
